...
export const playModeHandler = alexaSdk.CreateStateHandler(constants.states.PLAY_MODE, {
    ...
    'PlaybackNearlyFinished' : function(): Promise<any> {
        var that = this;
        var feedUrl = process.env["feed"];

        return podcastFeed.getFeed(feedUrl).then((feedData: any) => {
            /*
