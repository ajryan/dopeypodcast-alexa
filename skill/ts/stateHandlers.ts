...
import * as podcastFeed from './podcastFeed';
import * as constants from './constants';

export const startModeIntentHandlers = alexaSdk.CreateStateHandler(constants.states.START_MODE, {
        /*
        ...
        'LaunchRequest' : function () {
            ...
            return podcastFeed.getFeed(feedUrl).then((feed: any) => {
                console.log(feed);
    ...
    export const playModeIntentHandlers = alexaSdk.CreateStateHandler(constants.states.PLAY_MODE, {
        /*
    ...
    export const remoteControllerHandlers = alexaSdk.CreateStateHandler(constants.states.PLAY_MODE, {
        /*
    ...
    export const resumeDecisionModeIntentHandlers = alexaSdk.CreateStateHandler(constants.states.RESUME_DECISION_MODE, {
        /*
